...
import OutflowCategory from "@/components/icons/outflow-category";
...
export const pricingCards = [
  {
    title: "Starter",
    description: "Perfect for trying out outflow",
    price: "Free",
    duration: "",
...
export const addOnProducts = [
  { title: "Priority Support", id: "prod_PhuS85UuNA6us3" },
];
